...
const HireMe = () => {
  return (
    <div className='fixed left-4 bottom-4 flex items-center justify-center overflow-visible z-50 md:right-8 md:left-auto md:top-0 md:bottom-auto md:absolute sm:right-0 sm:top-0'>

      <div className='w-48 h-auto flex items-center justify-center relative md:w-24'>
        <CircularText className={"fill-dark animate-spin-slow dark:fill-light"} />

        <a
          href="mailto:ratnesh.singh1340@gmail.com"
          aria-label="mail"
